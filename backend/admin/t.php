...
include("../header.php");
include("../dbConn.php");
require_once("../config/jwt.php"); // include JWT helper functions
...
// Get token from Authorization header or POST/GET
...
if (!$token) {
    ...
    echo json_encode(["success" => false, "message" => "No token provided. Please login again."]);
    exit;
}

try {
    $decoded = decode_jwt($token); // from config/jwt.php
