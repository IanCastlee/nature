...
if ($method === "POST") {
    ...
    // =================================
    $checkStmt = $conn->prepare("SELECT inclusion FROM inclusions WHERE room_id = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $existingAmenities = $row['inclusion'];
        ...
        // Update query
        $updateStmt = $conn->prepare("UPDATE inclusions SET inclusion = ? WHERE room_id = ?");
