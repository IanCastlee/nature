          ...
          >
                ...
                >
                  ...
                  <div className="flex gap-3 mt-10">
                    <Button
                      ...
                      style="h-10 text-sm px-6 border border-gray-300 dark:border-gray-600 
           bg-white dark:bg-gray-800 
           ...
           rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
                    ...
                    <Button
                      ...
                      style={`flex-1 h-10 text-sm bg-blue-600 text-white font-semibold rounded-lg transition ${
                        isSubmitting
