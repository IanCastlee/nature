...
export default function ModalFormAnnouncement({
  showForm,
  setShowForm,
  form,
  formLoading,
  ...
  if (showForm !== "add_announcement" && showForm !== "update_announcement")
    return null;
